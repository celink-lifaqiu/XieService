...
public class ImageScale {
    ...
    public static void main(String[] args) throws Exception{
    	 BufferedImage image1 = ImageIO.read(new File("F:\\photo\\2.jpg"));
         int w = 80, h = 80;
         BufferedImage image2 = new ImageScale().imageZoomOut(image1, w, h, true);
         FileOutputStream out = new FileOutputStream("F:\\photo\\12_little.jpg");
